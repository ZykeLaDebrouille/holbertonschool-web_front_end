...
"""),
   ("14", """
 /* Inclure normalize.css ici */ @import url('https://necolas.github.io/normalize.css/latest/normalize.css');  
"""),
   ("15", """
...
.nav .nav-item { font-family :var(--nav-item-font-family) ; font-weight :var(--nav-item-font-weight) ; font-size :var(--nav-item-font-size) ; letter-spacing :.04em ; display:inline-block ; margin-bottom :.3em ; margin-top :.3em ; }  
...
"""),
   ("25", """:root{ --button-display:inline-block; --button-padding:.15em .30em; --button-border:.02rem solid var(#d73953); --button-color:#090909; --button-text-decoration:none; --button-font-size:.18em; --button-hover-color:#ffffff; --button-hover-text-decoration:none; --button-hover-background:#d73953;} .button{ display:inline-block;padding-left:.15em;padding-right:.30em;border:.02rem solid var(#d73953);color:#090909;text-decoration:none;font-size:.18em;} .button:hover{ color:#ffffff;text-decoration:none;background-color:#d73953;} [data-section-theme='dark'] .button{ color:#ffffff;}   
"""),
